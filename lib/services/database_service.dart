...
class DatabaseService {
  Future<List<PharmacyModel.Pharmacy>> getPharmaciesWithMedicine(String medicineName) async {
    List<PharmacyModel.Pharmacy> allPharmacies = await getPharmacies();
    List<PharmacyModel.Pharmacy> filteredPharmacies = allPharmacies.where((pharmacy) {
  ...
  Future<List<PharmacyModel.Pharmacy>> getPharmacies() async {
    List<PharmacyModel.Pharmacy> pharmacies = dummyPharmacies.map((pharmacy) {
      return PharmacyModel.Pharmacy(
        id: pharmacy.id,
        name: pharmacy.name,
        lat: pharmacy.lat,
        lon: pharmacy.lon,
